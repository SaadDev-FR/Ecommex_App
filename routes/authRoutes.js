...
router.post(
  ...
  adminAuthController.sendPasswordResetEmail
);
...
router.post(
  ...
  sellerAuthController.sendPasswordResetEmail
);
router.post("/seller/reset-password", sellerAuthController.resetPassword);

// WholeSeller
router.post(
  "/wholeSeller/register",
  wholeSellerAuthController.registerWholeSeller
);
router.post("/wholeSeller/login", wholeSellerAuthController.loginWholeSeller);
router.post(
  "/wholeSeller/forgot-password",
  wholeSellerAuthController.sendPasswordResetEmail
);
router.post(
  "/wholeSeller/reset-password",
  wholeSellerAuthController.resetPassword
);
