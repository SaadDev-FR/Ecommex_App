...
const create = async (req, res, next) => {
  try {
    ...
    res.status(201).json({ success: true, message: 'Category added successfully', category: result });
  } catch (error) {
...
const getCategorybyId = async (req, res, next) => {
  try {
    ...
    res.status(200).json({ success: true, message: 'Category retrieved successfully.', category: result });
  } catch (error) {
    res.status(400).json({ success: false, message: error.message });
  }
};
...
const updateCategory = async (req, res,next) => {
  try {
    ...
    res.status(200).json({ success: true, message: 'Category updated successfully.', category: result });
